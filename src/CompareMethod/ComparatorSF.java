...
public class ComparatorSF implements Comparator<Object> {
    @Override
    public int compare(Object objet1, Object objet2) {
        if (objet1 instanceof Anime && objet2 instanceof Anime) {
            ...
            boolean isSF1 = anime1.getCategorieAnime().equals("Science-Fiction");
            boolean isSF2 = anime2.getCategorieAnime().equals("Science-Fiction");
        ...
        else if(objet1 instanceof Film && objet2 instanceof Film)
        {
            ...
            boolean isSF1 = film1.getCategorieFilm().equals("Science-Fiction");
            boolean isSF2 = film2.getCategorieFilm().equals("Science-Fiction");
        ...
        else if(objet1 instanceof Serie && objet2 instanceof Serie)
        {
            ...
            boolean isSF1 = Serie1.getCategorieSerie().equals("Science-Fiction");
            boolean isSF2 = Serie2.getCategorieSerie().equals("Science-Fiction");
        ...
        else if(objet1 instanceof Trailer && objet2 instanceof Trailer)
        {
            ...
            boolean isSF1 = Trailer1.getCategorieTrailer().equals("Science-Fiction");
            boolean isSF2 = Trailer2.getCategorieTrailer().equals("Science-Fiction");
